...
import { Shield, ArrowLeft, Users, ShoppingBag, Package, Banknote, Settings, Bell, FileCheck, LogOut, Menu, Receipt, Gift } from "lucide-react";
...
const items = [
  ...
  { to: "/admin/campaigns", label: "Free Campaigns", icon: Gift },
